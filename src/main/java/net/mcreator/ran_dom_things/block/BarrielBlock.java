...
public class BarrielBlock extends RanDomThingsModElements.ModElement {
	@ObjectHolder("ran_dom_things:barriel")
	public static final Block block = null;
	public BarrielBlock(RanDomThingsModElements instance) {
		super(instance, 3);
	}
